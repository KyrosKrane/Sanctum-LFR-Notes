...
`/i To get to the next platform, just walk off the edge NEAR IT - not a random edge! We will go RIGHT - AWAY from the Jailer. If you run over black puddles, run to a back corner to get dispelled and drop them.`
